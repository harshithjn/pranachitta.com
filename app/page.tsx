...
import { ArrowRight, Leaf, Heart, Wind, Play, Users, Award, Quote, Calendar, MapPin, User , Move , Mail, Phone, Clock, Send, Instagram} from "lucide-react"
...
export default function Home() {
  ...
  <Image
    ...
    width={600}
    height={500}
    className="w-[600px] h-[500px] object-cover rounded-3xl shadow-2xl"
  />
</div>
    ...
    <div className="grid gap-8 sm:grid-cols-2">
      {[
        ...
        },
        {
          ...
          description:
            "Purifying and harmonizing your life energy through breath, movement and deep inner focus",
...
<div className="space-y-6 text-gray-700 leading-relaxed text-xl lg:text-xl">
  <p>
    Gitana brings over 17 years of dedicated practice and study in yoga, breathwork, meditation and somatic
    healing—years of this spent in India learning through traditional methods. Her work weaves together ancient
    wisdom traditions and modern therapeutic insight, offering a grounded, supportive space for personal
    exploration. With a focus on nervous system regulation and emotional integration, she guides people back
  ...
  <p>
    ...
    active meditations, the clarity and presence of Buddhist Mahamudra, the heart-opening path of Sufism and
    the devotional spirit of mantra chanting and Bhakti Yoga.
  </p>
  <p>
  ...
  <div className="w-120 h-120 overflow-hidden shadow-2xl rounded-lg">
    <Image
